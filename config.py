...
class Settings:
    ...
    market_data_retry_attempts:int=_int("MARKET_DATA_RETRY_ATTEMPTS",5)
    market_data_retry_delay_seconds:float=_float("MARKET_DATA_RETRY_DELAY_SECONDS",2.0)
    symbol_request_delay_seconds:float=_float("SYMBOL_REQUEST_DELAY_SECONDS",1.0)
